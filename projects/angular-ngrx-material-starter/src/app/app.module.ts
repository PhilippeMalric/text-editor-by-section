...
import { GameDirective } from './components/game/game.directive';
...
@NgModule({
  ...
  entryComponents: [ GameEasyComponent, GameHardComponent ],
  providers:[
    GameService,
    DataService,
    GoogleAuthService,
    { provide: SETTINGS, useValue: {} },{provide: MAT_BOTTOM_SHEET_DEFAULT_OPTIONS, useValue: {hasBackdrop: false}},
    D3Service],
